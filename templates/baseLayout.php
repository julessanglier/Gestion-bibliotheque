...
<html lang="fr">
  ...
  <body>
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
      ...
      <ul class="navbar-nav px-3">
        <li class="nav-item text-nowrap">
          <a class="nav-link" href="index.php?id=deconnexion">Déconnexion</a>
        </li>
      </ul>
    </header>
    ...
    <footer class="bg-light" style="text-align: center">
      <div class="container">
        <span class="text-muted">Département Informatique IUT d'Orléans - Année Spéciale</span>
      </div>
      <div class="container">
        <span class="text-muted">Jules SANGLIER</span>
      </div>
    </footer>
